...
`pnpm compat --json` compares 2662 cases from eslint-plugin-vue 10.11.0 against
our 111 common structural rules. CI checks the reviewed differences and also
