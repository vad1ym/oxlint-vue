...
`pnpm compat --json` compares 2464 cases from eslint-plugin-vue 10.11.0 against
our 102 common structural rules. CI checks the reviewed differences and also
