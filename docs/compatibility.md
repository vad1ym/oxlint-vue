...
| Corpus | Result |
|---|---|
| 2610 upstream cases, 108 common structural rules | **2609 exact matches (99.9%)** |
| Original generated cases: layout, CRLF, Unicode, entities, loop/slot scopes | **1224/1224** |
| Four pinned Nuxt components, each checked against all 108 rules | **432/432 comparisons** |
| Real oxlint pipeline including upstream props and scope regressions | **1774/1774 comparisons** |
...
and seven of the 108 suites currently match on every imported case.
...
exports 253 rule names; 152 are not measured by this structural-rule harness,
