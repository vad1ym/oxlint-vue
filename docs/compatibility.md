...
| Corpus | Result |
|---|---|
| 1166 upstream cases, 58 common structural rules | **1165 exact matches (99.9%)** |
| Original generated cases: layout, CRLF, Unicode, entities, loop/slot scopes | **864/864** |
| Four pinned Nuxt components, each checked against all 58 rules | **232/232 comparisons** |
| Real oxlint pipeline including upstream props and scope regressions | **1214/1214 comparisons** |
...
known failures. One parser-crashing case is explicitly excluded below. Fifty-seven
of the fifty-eight suites currently match on every imported case.
...
exports 253 rule names; 195 are not measured by this structural-rule harness,
